...
class Product(models.Model):
    ...
    shoe_size = models.CharField(max_length=10, choices=SHOE_SIZE_CHOICES, default="8")
    shoe_sex = models.CharField(max_length=10)
    shoe_type = models.CharField( max_length=50, choices=SHOE_TYPE_CHOICES, default='Sneakers')
    shoe_brand = models.CharField(max_length=50, choices=SHOE_BRAND_CHOICES, default='Nike')
